...
const OptionMenu = (props: itemType) => {
  ...
  return (
    <div className="fixed top-0 left-0 z-50 h-screen w-screen bg-zinc-900 text-gray-300 bg-opacity-30">
      <div className={" bg-zinc-900 text-gray-300 absolute top-1/2 left-1/2 z-20 h-auto w-[300px] -translate-x-1/2 -translate-y-1/2 transform rounded-2xl shadow-[0px_0px_10px_rgba(0,0,0,0.7)] md:w-[400px]"}>
