...
const ListOfUsers = (props: itemType) => {
  ...
  return (
    <div className="fixed top-0 left-0 z-20 h-screen w-screen select-none bg-zinc-900 bg-opacity-30 text-gray-300" onClick={() => props.onClickNegative}>
      <div className={"absolute top-1/2 left-1/2 z-20 grid w-[400px] -translate-x-1/2 -translate-y-1/2 transform place-items-center rounded-2xl bg-zinc-900  text-gray-300 shadow-[0px_0px_10px_rgba(0,0,0,0.7)]"}>
        <>
          ...
          {(props.users?.length || 0) > 0 ? (
            ...
            <div className={"flex flex-col items-center justify-center rounded-2xl bg-zinc-900 p-8 text-gray-300"}>
